...
CREATE TABLE internships (
    ...
    -- Alternatives:
    student_id INT NULL REFERENCES students(student_id) ON DELETE
    SET NULL,
        -- Keeps the internship but removes the student link
...
VALUES ('Rahul', 'rahul@gmail.com', 'Computer Science'),
    ('Sneha', 'sneha@yahoo.com', 'Information Tech'),
    ('Amit', 'amit@hotmail.com', 'Electronics'),
    ('Priya', 'priya@gmail.com', 'Mechanical'),
    -- Priya is focusing on higher studies, no internships.
    ('Rohan', 'rohan@outlook.com', 'Civil');
-- Rohan is working on a startup, no internships.
...
-- Student ID 99 does not exist (Orphan Record) -> Would be BLOCKED by Foreign Key Constraint
DELETE FROM students
WHERE student_id = 5;
-- What happens to Rahul's internships? (Google, Microsoft) -> Depends on our ON DELETE action!
-- ====================================================
