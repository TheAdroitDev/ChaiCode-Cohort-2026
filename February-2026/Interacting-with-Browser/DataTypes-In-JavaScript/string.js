...
const orders = "move-north|move-west|move-south";

const orderList = orders.split("|")
const safeOrderList = orderList.join(", ")
console.log("Split:", safeOrderList)
console.log("Split Datatype:", typeof orderList)